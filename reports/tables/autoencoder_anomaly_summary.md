...
Порог подозрительности выбран как 95-й процентиль ошибки восстановления на обучающей части (460 строк): `0.035353`.

Помечено подозрительных строк: 34 из 575 (5.9%).
